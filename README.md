# TestMU-Assignment
This assignment is given by TEstMu AI to showcase skills based on Automation, design decisions, boiler plate corrections,CICD integration, reporting and healthy use of AI
